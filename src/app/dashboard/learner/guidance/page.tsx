...
function LearnerGuidanceContent() {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            Tips, safety info, and FAQs to help you get the most from your sessions.
          </p>
        </div>
        <Link
...
export default function LearnerGuidancePage() {
  return (
    <RouteGuard allowedRole={["learner", "admin"]}>
      <LearnerGuidanceContent />
    </RouteGuard>
  );
}
